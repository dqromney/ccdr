...
//                HitbtcTrades.HitbtcTradesSortField.SORT_BY_TIMESTAMP, HitbtcTrades.HitbtcTradesSortDirection.SORT_DESCENDING, 0L, 1000L);
            ...
            // PoloniexPublicTrade[] trades = this.service.getPoloniexPublicTrades(currencyPair, System.currentTimeMillis() - DataReceiver.FETCH_FREQUENCY, null);
            PoloniexPublicTrade[] trades = this.service.getPoloniexPublicTrades(currencyPair, now - DataReceiver.FETCH_FREQUENCY/1000, null);
